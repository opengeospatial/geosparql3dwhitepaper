...
[#img_LBD_Server,reftext='{figure-caption} {counter:figure-num}']
.Linked Building Data Server using Semantic Graphs and GLTF-Models
image::../figures/LBD_Server_GUI.png[align="center"]
...
image::../figures/Surface_and_Line_Topological_Relations_in_2D_and_3D_Space.png[align="center", width="60%"]
...
image::../figures/Disjoint_with_Query2D_and_Query3D.png[align="center", width="50%"]
...
[#img_Topological_relations_2D, reftext='{figure-caption} {counter:figure-num}']
.2D Topological relations for 3D objects
image::../figures/Topological_relations_2D.png[align="center", width="50%"]

[#img_Topological_relations_3D, reftext='{figure-caption} {counter:figure-num}']
.3D Topological relations for 3D objects
image::../figures/Topological_relations_3D.png[align="center"]
...
https://github.com/opengeospatial/ogc-geosparql/issues/684
...
[#img_Topological_and_directional_relations_3D, reftext='{figure-caption} {counter:figure-num}']
.3D Topological and Directional relations for 3D objects
image::../figures/Topological_and_directional_relation_combined.png[align="center", width="50%"]
...
Ideas: https://isprs-archives.copernicus.org/articles/XLII-4/11/2018/ USING THE COMBINED LADM-INDOORGML MODEL TO SUPPORT BUIILDING EVACUATION

and: 3D pgRouting and Visualization in Cesium JS Using the Integrated Model of LADM and IndoorGML

[#img_Routing_Space_door_nodes_and_edges, reftext='{figure-caption} {counter:figure-num}']
.Space and doors nodes and connecting edges for routing. 
image::../figures/Space-node-Door-node-and-Edge.png[align="center", width="50%"]
...
[#img_OntoPreHer3D,reftext='{figure-caption} {counter:figure-num}']
.Diagram illustrating the use of the OntPreHer3D ontology for the hypothetical virtual 3D reconstruction process with the use of a simulation event. 
image::../figures/OntoPreHer3D.jpeg[align="center"]
...
[#img_LBD_Server,reftext='{figure-caption} {counter:figure-num}']
.Model of a bridge where the bridge parts "Pier" and "Deck" contain the geometries of the bridge. 
image::../figures/IFC_To_CityGML_Use_Case_Bridge.png[align="center"]
