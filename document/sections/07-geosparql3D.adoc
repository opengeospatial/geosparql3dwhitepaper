...
image::../figures/Topological_relations_3D.png[align="center", width="50%"]

===== Extension {counter:ext}: Directional relations of 3D geometries

====== GitHub Issue URI

This extension is included without a corresponding GitHub issue. The motivation is instead based on the identified need to represent and query directional relationships between 3D geometries. This need is also supported by related work by Anne Göbels, Jakob Beetz, and Ina Heise, as discussed in the Related Work chapter.
