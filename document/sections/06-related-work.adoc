...
| Cultural heritage | Building-conservation ontology for 3D annotations <<messaoudi2018heritage>>; CIDOC CRM–based models for 3D CH objects and provenance <<walczak2019inference>> <<amico2106ontological>> <<гончар2021ontological>>. |
...
==== ChgOnto
Grottoes & heritage ontology  for grotto components, spatial relations, with GeoSPARQL + CIDOC CRM <<yang2023knowledge>>. 
