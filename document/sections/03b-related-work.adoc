...
| Cultural heritage | Building-conservation ontology for 3D annotations <<messaoudi2018heritage>>; CIDOC CRM–based models for 3D CH objects and provenance [11] [12] [13]. |
